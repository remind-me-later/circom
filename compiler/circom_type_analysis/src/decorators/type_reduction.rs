use circom_ast::*;
use circom_program_structure::environment::CircomEnvironment;
use circom_program_structure::function_data::FunctionData;
use circom_program_structure::template_data::TemplateData;
