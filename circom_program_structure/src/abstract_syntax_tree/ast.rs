...
pub fn build_main_component(public: Vec<String>, call: Expression) -> MainComponent {
    MainComponent { public_inputs: public, initial_template_call: call }
}

#[derive(Clone, Debug)]
pub struct Version {
    pub version: usize,
    pub subversion: usize,
    pub subsubversion: usize,
}
...
impl TypeKnowledge {
    ...
    pub fn get_reduces_to(&self) -> TypeReduction {
        self.reduces_to.expect("reduces_to knowledge is been look at without being initialized")
    }
...
impl MemoryKnowledge {
    ...
    pub fn set_concrete_dimensions(&mut self, value: Vec<usize>) {
        self.full_length = Some(value.iter().product());
    ...
    pub fn get_concrete_dimensions(&self) -> &[usize] {
        self.concrete_dimensions
            .as_ref()
            .expect("concrete dimensions was look at without being initialized")
    }

    pub fn get_full_length(&self) -> usize {
        self.full_length.expect("full dimension was look at without being initialized")
    }

    pub fn get_abstract_memory_address(&self) -> usize {
        self.abstract_memory_address
            .expect("abstract memory address was look at without being initialized")
    }
}
